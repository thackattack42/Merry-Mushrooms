...
public class PlayerArrowDamage : MonoBehaviour
{
    public void OnCollisionEnter(Collision collision)
    {
        if (gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].earth)
        {
            ...
            if (earthDamage != null)
                earthDamage.TakeEarthDamage((gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].bowShootDamage) * (int)(gameManager.instance.playerScript.timer));
        }
        ...
        if (gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].ice)
        {
            ...
            if (iceDamage != null)
                iceDamage.TakeIceDamage((gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].bowShootDamage) * (int)(gameManager.instance.playerScript.timer));
        }
        if (gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].fire)
        {
            ...
            if (fireDamge != null)
                fireDamge.TakeFireDamage((gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].bowShootDamage) * (int)(gameManager.instance.playerScript.timer));
        }
        if (gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].baseStaff)
        {
            ...
            if (damageable != null)
                damageable.takeDamage((gameManager.instance.playerScript.BowList[gameManager.instance.playerScript.selectedBow].bowShootDamage) * (int)(gameManager.instance.playerScript.timer));
