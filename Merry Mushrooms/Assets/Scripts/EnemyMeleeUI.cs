...
public class EnemyMeleeUI : MonoBehaviour
{
    public static EnemyMeleeUI instance;

    [Header("-----Enemy Stuff-----")]
    public GameObject enemy;
    public EnemyMelee_Scpt enemyScript;
    ...
    void Start()
    {
        ...
        enemyScript = enemy.GetComponent<EnemyMelee_Scpt>();
